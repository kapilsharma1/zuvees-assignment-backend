...
// New image URLs for Xbox consoles using different reliable sources
const xboxSeriesXImages = [
  'https://i.rtings.com/assets/products/YVr237Lb/microsoft-xbox-series-x/design-medium.jpg',
  'https://i.rtings.com/assets/products/cHEVbMgo/microsoft-xbox-series-x/design-large.jpg'
];

const xboxSeriesSImages = [
  'https://i.rtings.com/assets/products/pHNGzZ9A/microsoft-xbox-series-s/design-medium.jpg',
  'https://i.rtings.com/assets/products/6xaJsQi5/microsoft-xbox-series-s/design-large.jpg'
];

const fixXboxImages = async () => {
  try {
    ...
    // Log all products to verify what's in the database
    const allProducts = await Product.find();
    console.log(`Found ${allProducts.length} total products in the database`);
    allProducts.forEach(product => {
      console.log(`Product: ${product.name}, Images: ${product.images.length}, ID: ${product._id}`);
    });
